...
go test github.com/agentplexus/go-comet-ml-opik -v

# Evaluation heuristic metrics
go test github.com/agentplexus/go-comet-ml-opik/evaluation/heuristic -v
```
...
```bash
go test github.com/agentplexus/go-comet-ml-opik -v -run TestConfig
go test github.com/agentplexus/go-comet-ml-opik -v -run TestContext
```
